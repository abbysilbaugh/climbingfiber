...
function [increase_cells, decrease_cells, active_PRE_RWS, active_POST_RWS] = visualizebarplots_presentation(allData, selectmottype, evoked_win, max_win, plottype, ylimit)
