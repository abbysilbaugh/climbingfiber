...
for i = 1:length(neuron_names)
        ...
        if strcmp(showtraces, 'yesplot')
            ...
            rectangle('Position', [win1(1), 0, win1(2)-win1(1), 10], 'FaceColor', [0.5, 0.5, 0.5, 0.5], 'EdgeColor', 'none')
            hold on
            rectangle('Position', [win2(1), 0, win2(2)-win2(1), 10], 'FaceColor', [0.5, 0.5, 0.5, 0.5], 'EdgeColor', 'none')
