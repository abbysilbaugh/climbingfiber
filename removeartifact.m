% Manually identify frames with opto stimulus artifact and visually verify.
% Update default artifact frames and resave _artifactframes.mat file as necessary
...
%     end
% end
%% Reject trials if necessary
% reject_trials (open and use if signal was not recorded properly)
