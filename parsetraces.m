...
function [pre, pre_wo, ...
    ...
    = parsetraces(baselineshiftperiod, baselineshift, baseline_reject_thresh, trialavg, cellavg, catmouse, mottype, allData, signaltype, setmice)
...
for i = setmice.RWS_PV_Gq_mice
    [RWS_PV_Gq_pre{i, 1}, RWS_PV_Gq_pre_wo{i, 1}, RWS_PV_Gq_pre_dcz{i, 1}, RWS_PV_Gq_post{i, 1}] = parsemouse(mottype, 'PV', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWS_PV_Gq_pre{i, 2}, RWS_PV_Gq_pre_wo{i, 2}, RWS_PV_Gq_pre_dcz{i, 2}, RWS_PV_Gq_post{i, 2}] = parsemouse(mottype, 'PN', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWS_PV_Gq_pre{i, 3}, RWS_PV_Gq_pre_wo{i, 3}, RWS_PV_Gq_pre_dcz{i, 3}, RWS_PV_Gq_post{i, 3}] = parsemouse(mottype, 'VIP', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWS_PV_Gq_pre{i, 4}, RWS_PV_Gq_pre_wo{i, 4}, RWS_PV_Gq_pre_dcz{i, 4}, RWS_PV_Gq_post{i, 4}] = parsemouse(mottype, 'UC', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWS_PV_Gq_pre{i, 5}, RWS_PV_Gq_pre_wo{i, 5}, RWS_PV_Gq_pre_dcz{i, 5}, RWS_PV_Gq_post{i, 5}] = parsemouse(mottype, 'SST', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
end
...
for i = setmice.control_PV_Gq_mice
    [control_PV_Gq_pre{i, 1}, control_PV_Gq_pre_wo{i, 1}, control_PV_Gq_pre_dcz{i, 1}, control_PV_Gq_post{i, 1}] = parsemouse(mottype, 'PV', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_PV_Gq_pre{i, 2}, control_PV_Gq_pre_wo{i, 2}, control_PV_Gq_pre_dcz{i, 2}, control_PV_Gq_post{i, 2}] = parsemouse(mottype, 'PN', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_PV_Gq_pre{i, 3}, control_PV_Gq_pre_wo{i, 3}, control_PV_Gq_pre_dcz{i, 3}, control_PV_Gq_post{i, 3}] = parsemouse(mottype, 'VIP', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_PV_Gq_pre{i, 4}, control_PV_Gq_pre_wo{i, 4}, control_PV_Gq_pre_dcz{i, 4}, control_PV_Gq_post{i, 4}] = parsemouse(mottype, 'UC', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_PV_Gq_pre{i, 5}, control_PV_Gq_pre_wo{i, 5}, control_PV_Gq_pre_dcz{i, 5}, control_PV_Gq_post{i, 5}] = parsemouse(mottype, 'SST', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
end
...
for i = setmice.RWSCF_VIP_Gq_mice
    [RWSCF_VIP_Gq_pre{i, 1}, RWSCF_VIP_Gq_pre_wo{i, 1}, RWSCF_VIP_Gq_pre_dcz{i, 1}, RWSCF_VIP_Gq_post{i, 1}] = parsemouse(mottype, 'PV', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWSCF_VIP_Gq_pre{i, 2}, RWSCF_VIP_Gq_pre_wo{i, 2}, RWSCF_VIP_Gq_pre_dcz{i, 2}, RWSCF_VIP_Gq_post{i, 2}] = parsemouse(mottype, 'PN', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWSCF_VIP_Gq_pre{i, 3}, RWSCF_VIP_Gq_pre_wo{i, 3}, RWSCF_VIP_Gq_pre_dcz{i, 3}, RWSCF_VIP_Gq_post{i, 3}] = parsemouse(mottype, 'VIP', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWSCF_VIP_Gq_pre{i, 4}, RWSCF_VIP_Gq_pre_wo{i, 4}, RWSCF_VIP_Gq_pre_dcz{i, 4}, RWSCF_VIP_Gq_post{i, 4}] = parsemouse(mottype, 'UC', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWSCF_VIP_Gq_pre{i, 5}, RWSCF_VIP_Gq_pre_wo{i, 5}, RWSCF_VIP_Gq_pre_dcz{i, 5}, RWSCF_VIP_Gq_post{i, 5}] = parsemouse(mottype, 'SST', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
end
...
for i = setmice.control_VIP_Gq_mice
    [control_VIP_Gq_pre{i, 1}, control_VIP_Gq_pre_wo{i, 1}, control_VIP_Gq_pre_dcz{i, 1}, control_VIP_Gq_post{i, 1}] = parsemouse(mottype, 'PV', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_VIP_Gq_pre{i, 2}, control_VIP_Gq_pre_wo{i, 2}, control_VIP_Gq_pre_dcz{i, 2}, control_VIP_Gq_post{i, 2}] = parsemouse(mottype, 'PN', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_VIP_Gq_pre{i, 3}, control_VIP_Gq_pre_wo{i, 3}, control_VIP_Gq_pre_dcz{i, 3}, control_VIP_Gq_post{i, 3}] = parsemouse(mottype, 'VIP', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_VIP_Gq_pre{i, 4}, control_VIP_Gq_pre_wo{i, 4}, control_VIP_Gq_pre_dcz{i, 4}, control_VIP_Gq_post{i, 4}] = parsemouse(mottype, 'UC', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_VIP_Gq_pre{i, 5}, control_VIP_Gq_pre_wo{i, 5}, control_VIP_Gq_pre_dcz{i, 5}, control_VIP_Gq_post{i, 5}] = parsemouse(mottype, 'SST', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
end
...
for i = setmice.RWS_VIP_Gi_mice
    [RWS_VIP_Gi_pre{i, 1}, RWS_VIP_Gi_pre_wo{i, 1}, RWS_VIP_Gi_pre_dcz{i, 1}, RWS_VIP_Gi_post{i, 1}] = parsemouse(mottype, 'PV', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWS_VIP_Gi_pre{i, 2}, RWS_VIP_Gi_pre_wo{i, 2}, RWS_VIP_Gi_pre_dcz{i, 2}, RWS_VIP_Gi_post{i, 2}] = parsemouse(mottype, 'PN', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWS_VIP_Gi_pre{i, 3}, RWS_VIP_Gi_pre_wo{i, 3}, RWS_VIP_Gi_pre_dcz{i, 3}, RWS_VIP_Gi_post{i, 3}] = parsemouse(mottype, 'VIP', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWS_VIP_Gi_pre{i, 4}, RWS_VIP_Gi_pre_wo{i, 4}, RWS_VIP_Gi_pre_dcz{i, 4}, RWS_VIP_Gi_post{i, 4}] = parsemouse(mottype, 'UC', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [RWS_VIP_Gi_pre{i, 5}, RWS_VIP_Gi_pre_wo{i, 5}, RWS_VIP_Gi_pre_dcz{i, 5}, RWS_VIP_Gi_post{i, 5}] = parsemouse(mottype, 'SST', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
end
...
for i = setmice.control_VIP_Gi_mice
    [control_VIP_Gi_pre{i, 1}, control_VIP_Gi_pre_wo{i, 1}, control_VIP_Gi_pre_dcz{i, 1}, control_VIP_Gi_post{i, 1}] = parsemouse(mottype, 'PV', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_VIP_Gi_pre{i, 2}, control_VIP_Gi_pre_wo{i, 2}, control_VIP_Gi_pre_dcz{i, 2}, control_VIP_Gi_post{i, 2}] = parsemouse(mottype, 'PN', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_VIP_Gi_pre{i, 3}, control_VIP_Gi_pre_wo{i, 3}, control_VIP_Gi_pre_dcz{i, 3}, control_VIP_Gi_post{i, 3}] = parsemouse(mottype, 'VIP', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_VIP_Gi_pre{i, 4}, control_VIP_Gi_pre_wo{i, 4}, control_VIP_Gi_pre_dcz{i, 4}, control_VIP_Gi_post{i, 4}] = parsemouse(mottype, 'UC', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [control_VIP_Gi_pre{i, 5}, control_VIP_Gi_pre_wo{i, 5}, control_VIP_Gi_pre_dcz{i, 5}, control_VIP_Gi_post{i, 5}] = parsemouse(mottype, 'SST', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
end
...
SST_Gi_ZI_pre_dcz_wo = cell(nMice, 5);

for i = setmice.SST_Gi_ZI_mice
    [SST_Gi_ZI_pre{i, 1}, SST_Gi_ZI_pre_wo{i, 1}, SST_Gi_ZI_pre_dcz{i, 1}, SST_Gi_ZI_pre_dcz_wo{i, 1}] = parsemouse_ZI(mottype, 'PV', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [SST_Gi_ZI_pre{i, 2}, SST_Gi_ZI_pre_wo{i, 2}, SST_Gi_ZI_pre_dcz{i, 2}, SST_Gi_ZI_pre_dcz_wo{i, 2}] = parsemouse_ZI(mottype, 'PN', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [SST_Gi_ZI_pre{i, 3}, SST_Gi_ZI_pre_wo{i, 3}, SST_Gi_ZI_pre_dcz{i, 3}, SST_Gi_ZI_pre_dcz_wo{i, 3}] = parsemouse_ZI(mottype, 'VIP', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [SST_Gi_ZI_pre{i, 4}, SST_Gi_ZI_pre_wo{i, 4}, SST_Gi_ZI_pre_dcz{i, 4}, SST_Gi_ZI_pre_dcz_wo{i, 4}] = parsemouse_ZI(mottype, 'UC', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [SST_Gi_ZI_pre{i, 5}, SST_Gi_ZI_pre_wo{i, 5}, SST_Gi_ZI_pre_dcz{i, 5}, SST_Gi_ZI_pre_dcz_wo{i, 5}] = parsemouse_ZI(mottype, 'SST', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
end
...
PV_Gi_ZI_pre_dcz_wo = cell(nMice, 5);

for i = setmice.PV_Gi_ZI_mice
    [PV_Gi_ZI_pre{i, 1}, PV_Gi_ZI_pre_wo{i, 1}, PV_Gi_ZI_pre_dcz{i, 1}, PV_Gi_ZI_pre_dcz_wo{i, 1}] = parsemouse_ZI(mottype, 'PV', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [PV_Gi_ZI_pre{i, 2}, PV_Gi_ZI_pre_wo{i, 2}, PV_Gi_ZI_pre_dcz{i, 2}, PV_Gi_ZI_pre_dcz_wo{i, 2}] = parsemouse_ZI(mottype, 'PN', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [PV_Gi_ZI_pre{i, 3}, PV_Gi_ZI_pre_wo{i, 3}, PV_Gi_ZI_pre_dcz{i, 3}, PV_Gi_ZI_pre_dcz_wo{i, 3}] = parsemouse_ZI(mottype, 'VIP', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [PV_Gi_ZI_pre{i, 4}, PV_Gi_ZI_pre_wo{i, 4}, PV_Gi_ZI_pre_dcz{i, 4}, PV_Gi_ZI_pre_dcz_wo{i, 4}] = parsemouse_ZI(mottype, 'UC', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
    [PV_Gi_ZI_pre{i, 5}, PV_Gi_ZI_pre_wo{i, 5}, PV_Gi_ZI_pre_dcz{i, 5}, PV_Gi_ZI_pre_dcz_wo{i, 5}] = parsemouse_ZI(mottype, 'SST', allData, i, signaltype, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg);
end
...
if cellavg
    ...
    SST_Gi_ZI_pre_dcz_wo = cellaverage(SST_Gi_ZI_pre_dcz_wo);
    ...
    PV_Gi_ZI_pre_dcz_wo = cellaverage(PV_Gi_ZI_pre_dcz_wo);
