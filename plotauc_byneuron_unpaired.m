function plotauc_byneuron_unpaired(m1_cond1, m1_cond2, m2_cond1, m2_cond2, neuron_colors, plotscatter, evoked_win, group_names, condition_names, ylimits)
...
p_m1_PV = rununpairedstats1(m1_PV, 'PV; RWS');
p_m1_PN = rununpairedstats1(m1_PN, 'PN; RWS');
p_m1_VIP = rununpairedstats1(m1_VIP, 'VIP; RWS');
p_m1_UC = rununpairedstats1(m1_UC, 'UC; RWS');
p_m1_SST = rununpairedstats1(m1_SST, 'SST; RWS');

p_m2_PV = rununpairedstats1(m2_PV, 'PV; RWS+CF');
p_m2_PN = rununpairedstats1(m2_PN, 'PN; RWS+CF');
p_m2_VIP = rununpairedstats1(m2_VIP, 'VIP; RWS+CF');
p_m2_UC = rununpairedstats1(m2_UC, 'UC; RWS+CF');
p_m2_SST = rununpairedstats1(m2_SST, 'SST; RWS+CF');
...
function p = rununpairedstats1(data, cellType)
if ~isempty(data)
