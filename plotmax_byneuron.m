function plotmax_byneuron(m1_cond1, m1_cond2, m2_cond1, m2_cond2, neuron_colors, plotlines, evoked_win, group_names, condition_names, ylimits)
...
figure('Position', [880,695,952,185]);
title('Group 1 (Cond 1 vs Cond 2; each neuron)')
subplot(1, 5, 1)
if ~isempty(m1_PN)
daboxplot(m1_PN,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', [0.5 0.5 0.5], 'linkline', 1);
ylim(ylimits)
if p_m1_PN < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
title(group_names(1))
end
ylabel('Maximum (ΔF/F0)')
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')

subplot(1, 5, 2)
if ~isempty(m1_UC)
daboxplot(m1_UC,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', [0.5 0.5 0.5], 'linkline', 1);
ylim(ylimits)
if p_m1_UC < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
...
subplot(1, 5, 3)
if ~isempty(m1_VIP)
daboxplot(m1_VIP,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', [0.5 0.5 0.5], 'linkline', 1);
ylim(ylimits)
if p_m1_VIP < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
...
subplot(1, 5, 4)
if ~isempty(m1_SST)
daboxplot(m1_SST,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', [0.5 0.5 0.5], 'linkline', 1);
ylim(ylimits)
if p_m1_SST < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
...
subplot(1, 5, 5)
if ~isempty(m1_PV)
daboxplot(m1_PV,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', [0.5 0.5 0.5], 'linkline', 1);
ylim(ylimits)
if p_m1_PV < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
...
subplot(1, 5, 1)
if ~isempty(m2_PN)
daboxplot(m2_PN,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', neuron_colors{2}, 'linkline', 1);
ylim(ylimits)
if p_m2_PN < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 2)
if ~isempty(m2_UC)
daboxplot(m2_UC,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', neuron_colors{4}, 'linkline', 1);
ylim(ylimits)
if p_m2_UC < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 3)
if ~isempty(m2_VIP)
daboxplot(m2_VIP,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', neuron_colors{3}, 'linkline', 1);
ylim(ylimits)
if p_m2_VIP < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 4)
if ~isempty(m2_SST)
daboxplot(m2_SST,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', neuron_colors{5}, 'linkline', 1);
ylim(ylimits)
if p_m2_SST < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 5)
if ~isempty(m2_PV)
daboxplot(m2_PV,'xtlabels', condition_names,'whiskers',1,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'withinlines',plotlines,'outliers',0, 'color', neuron_colors{1}, 'linkline', 1);
ylim(ylimits)
if p_m2_PV < 0.05
    text(1.5, 0.1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
daboxplot(PNs,'linkline',1,...
    ...
    'whiskers',1,'outliers',0,'outsymbol','r*','scatter',0,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{2}]);
ylabel('Maximum (ΔF/F0)'); 
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
...
daboxplot(UCs,'linkline',1,...
    'xtlabels', condition_names,...
    'whiskers',1,'outliers',0,'outsymbol','r*','scatter',0,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{4}]);
ylabel('Maximum (ΔF/F0)'); 
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
...
daboxplot(VIPs,'linkline',1,...
    'xtlabels', condition_names,...
    'whiskers',1,'outliers',0,'outsymbol','r*','scatter',0,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{3}]);
ylabel('Maximum (ΔF/F0)'); 
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
...
daboxplot(PVs,'linkline',1,...
    'xtlabels', condition_names,...
    'whiskers',1,'outliers',0,'outsymbol','r*','scatter',0,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{1}]);
ylabel('Maximum (ΔF/F0)'); 
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
...
daboxplot(SSTs,'linkline',1,...
    'xtlabels', condition_names,...
    'whiskers',1,'outliers',0,'outsymbol','r*','scatter',0,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{5}]);
ylabel('Maximum (ΔF/F0)'); 
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
