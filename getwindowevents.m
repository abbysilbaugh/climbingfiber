% adds to allData.data{mouse}...
    % evoked_pkLocs (nCells x nTrials)
    % evoked_spkLocs (nCells x nTrials)
    % evoked_amps (nCells x nTrials)
    % maxevoeked_pkLoc (nCells x nTrials)
    % maxevoked_amp (nCells x nTrials)
    % sumevoked_spk (nCells x nTrials)
