function plotauc_byneuron_box_outlier(m1_cond1, m1_cond2, m2_cond1, m2_cond2, neuron_colors, plotscatter, evoked_win, group_names, condition_names, ylimits)
...
daboxplot(m1_PN,'xtlabels', condition_names,'fill', 0,...
    'scatter',plotscatter,'scattersize',3,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{2}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_PN < 0.05
...
subplot(1, 5, 2)
if ~isempty(m1_UC)
daboxplot(m1_UC,'xtlabels', condition_names,'fill', 0,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{4}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_UC < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
subplot(1, 5, 3)
if ~isempty(m1_VIP)
daboxplot(m1_VIP,'xtlabels', condition_names,'fill', 0,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{3}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_VIP < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
subplot(1, 5, 4)
if ~isempty(m1_SST)
daboxplot(m1_SST,'xtlabels', condition_names,'fill', 0,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{5}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_SST < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
subplot(1, 5, 5)
if ~isempty(m1_PV)
daboxplot(m1_PV,'xtlabels', condition_names,'fill', 0,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{1}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_PV < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
daboxplot(m2_PN,'xtlabels', condition_names,'fill', 1,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{2}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m2_PN < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
subplot(1, 5, 2)
if ~isempty(m2_UC)
daboxplot(m2_UC,'xtlabels', condition_names,'fill', 1,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{4}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m2_UC < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
...
subplot(1, 5, 3)
if ~isempty(m2_VIP)
daboxplot(m2_VIP,'xtlabels', condition_names,'fill', 1,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{3}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m2_VIP < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
...
subplot(1, 5, 4)
if ~isempty(m2_SST)
daboxplot(m2_SST,'xtlabels', condition_names,'fill', 1,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{5}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m2_SST < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
...
subplot(1, 5, 5)
if ~isempty(m2_PV)
daboxplot(m2_PV,'xtlabels', condition_names,'fill', 1,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers', 1, 'color', neuron_colors{1}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m2_PV < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
...
daboxplot(PNs,'linkline',1,...
    ...
    'whiskers',1,'outliers', 1,'outsymbol','r*','scatter', 0,'scattersize', 2,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{2}]);
ylabel('AUC (∆F/F0)'); 
set(gca, 'FontSize', 7, 'FontName', 'Helvetica')
end
ylim(ylimits)
...
daboxplot(UCs,'linkline',1,...
    'xtlabels', condition_names,...
    'whiskers',1,'outliers', 1,'outsymbol','r*','scatter', 0,'scattersize', 2,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{4}]);
ylabel('AUC (∆F/F0)'); 
set(gca, 'FontSize', 7, 'FontName', 'Helvetica')
end
ylim(ylimits)
...
daboxplot(VIPs,'linkline',1,...
    'xtlabels', condition_names,...
    'whiskers',1,'outliers', 1,'outsymbol','r*','scatter', 0,'scattersize', 2,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{3}]);
ylabel('AUC (∆F/F0)'); 
set(gca, 'FontSize', 7, 'FontName', 'Helvetica')
end
ylim(ylimits)
...
daboxplot(PVs,'linkline',1,...
    'xtlabels', condition_names,...
    'whiskers',1,'outliers', 1,'outsymbol','r*','scatter', 0,'scattersize', 2,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{1}]);
ylabel('AUC (∆F/F0)'); 
set(gca, 'FontSize', 7, 'FontName', 'Helvetica')
end
ylim(ylimits)
...
daboxplot(SSTs,'linkline',1,...
    'xtlabels', condition_names,...
    'whiskers',1,'outliers', 1,'outsymbol','r*','scatter', 0,'scattersize', 2,'boxalpha',0.6, 'color', [[.5 .5 .5]; neuron_colors{5}]);
ylabel('AUC (∆F/F0)'); 
set(gca, 'FontSize', 7, 'FontName', 'Helvetica')
end
ylim(ylimits)
