function plotmax_byneuronBT(m1_cond1, m1_cond2, neuron_colors, evoked_win, condition_names, ylimits, statstype)
...
figure('Position', [255,651,838,142]);
...
subplot(1, 5, 2)
if ~isempty(m1_UC)
dabarplot(m1_UC,'xtlabels', condition_names,...
