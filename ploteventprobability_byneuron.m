function ploteventprobability_byneuron(m1_cond1, m1_cond2, m2_cond1, m2_cond2, neuron_colors, plotlines, group_names, condition_names)
...
ylim([0 1])
if p_m1_PN < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize',100);
end
title(group_names(1))
end
...
for i = 1:5
    ...
    % Plot data
    subplot(1, 5, i);
    scatter(m1(:, 1), m1(:, 2), 5, 'MarkerEdgeColor', 'none', 'MarkerFaceColor', [0.5 0.5 0.5], 'MarkerFaceAlpha', 1);
    hold on;
    scatter(m2(:, 1), m2(:, 2), 5, 'MarkerEdgeColor', 'none', 'MarkerFaceColor', neuron_colors{i}, 'MarkerFaceAlpha', 1);
    % Plot the line y=x
