function plotauc_byneuron_box(m1_cond1, m1_cond2, m2_cond1, m2_cond2, neuron_colors, plotscatter, evoked_win, group_names, condition_names, ylimits)
...
daboxplot(m1_UC,'xtlabels', condition_names,'fill', 0,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers',0, 'color', neuron_colors{4}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_UC < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
daboxplot(m1_VIP,'xtlabels', condition_names,'fill', 0,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers',0, 'color', neuron_colors{3}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_VIP < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
daboxplot(m1_SST,'xtlabels', condition_names,'fill', 0,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers',0, 'color', neuron_colors{5}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_SST < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
daboxplot(m1_PV,'xtlabels', condition_names,'fill', 0,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers',0, 'color', neuron_colors{1}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m1_PV < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
...
daboxplot(m2_PN,'xtlabels', condition_names,'fill', 1,...
    'scatter', plotscatter,'scattersize',2,'scatteralpha',1,'outliers',0, 'color', neuron_colors{2}, 'mean', '1', 'whiskers', 1);
ylim(ylimits)
if p_m2_PN < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 20);
end
