function [getvar, vartype] = grabTHRESHdata(allData, cellType, cellmotType, trialType, trialmotType, tetPeriod, variable, exclude, PSI)
...
for i = 1:nMice
    ...
    temp_trialTHRESHType = allData.data{i}.PSItrialType;
    ...
    if strcmp(PSI, 'all')
        ...
        tID4 = strcmp(temp_trialTHRESHType, PSI);
    end
