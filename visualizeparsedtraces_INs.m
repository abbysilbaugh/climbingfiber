...
function visualizeparsedtraces_INs(choosecell, neuron_colors, xlimits, ylimits, stimframe,...
    pre, pre_wo, ...
...
getmean_RWS_pre = mean(RWS_pre{choosecell}, 2, 'omitnan');
getmean_RWS_post = mean(RWS_post{choosecell}, 2, 'omitnan');

getmean_RWSCF_pre = mean(RWSCF_pre{choosecell}, 2, 'omitnan');
getmean_RWSCF_post = mean(RWSCF_post{choosecell}, 2, 'omitnan');

getmean_RWSCF_PV_JAWS_pre = mean(RWSCF_PV_JAWS_pre{choosecell}, 2, 'omitnan');
getmean_RWSCF_PV_JAWS_post = mean(RWSCF_PV_JAWS_post{choosecell}, 2, 'omitnan');

getmean_control_PV_JAWS_pre = mean(control_PV_JAWS_pre{choosecell}, 2, 'omitnan');
getmean_control_PV_JAWS_post = mean(control_PV_JAWS_post{choosecell}, 2, 'omitnan');

getmean_RWSCF_PV_Gi_pre = mean(RWSCF_PV_Gi_pre{choosecell}, 2, 'omitnan');
getmean_RWSCF_PV_Gi_pre_dcz = mean(RWSCF_PV_Gi_pre_dcz{choosecell}, 2, 'omitnan');
getmean_RWSCF_PV_Gi_post = mean(RWSCF_PV_Gi_post{choosecell}, 2, 'omitnan');

getmean_control_PV_Gi_pre = mean(control_PV_Gi_pre{choosecell}, 2, 'omitnan');
getmean_control_PV_Gi_pre_dcz = mean(control_PV_Gi_pre_dcz{choosecell}, 2, 'omitnan');
getmean_control_PV_Gi_post = mean(control_PV_Gi_post{choosecell}, 2, 'omitnan');

getmean_RWS_PV_Gq_pre = mean(RWS_PV_Gq_pre{choosecell}, 2, 'omitnan');
getmean_RWS_PV_Gq_pre_dcz = mean(RWS_PV_Gq_pre_dcz{choosecell}, 2, 'omitnan');
getmean_RWS_PV_Gq_post = mean(RWS_PV_Gq_post{choosecell}, 2, 'omitnan');

getmean_control_PV_Gq_pre = mean(control_PV_Gq_pre{choosecell}, 2, 'omitnan');
getmean_control_PV_Gq_pre_dcz = mean(control_PV_Gq_pre_dcz{choosecell}, 2, 'omitnan');
getmean_control_PV_Gq_post = mean(control_PV_Gq_post{choosecell}, 2, 'omitnan');

getmean_RWSCF_SST_Gi_pre = mean(RWSCF_SST_Gi_pre{choosecell}, 2, 'omitnan');
getmean_RWSCF_SST_Gi_pre_dcz = mean(RWSCF_SST_Gi_pre_dcz{choosecell}, 2, 'omitnan');
getmean_RWSCF_SST_Gi_post = mean(RWSCF_SST_Gi_post{choosecell}, 2, 'omitnan');

getmean_control_SST_Gi_pre = mean(control_SST_Gi_pre{choosecell}, 2, 'omitnan');
getmean_control_SST_Gi_pre_dcz = mean(control_SST_Gi_pre_dcz{choosecell}, 2, 'omitnan');
getmean_control_SST_Gi_post = mean(control_SST_Gi_post{choosecell}, 2, 'omitnan');

getmean_RWS_SST_Gq_pre = mean(RWS_SST_Gq_pre{choosecell}, 2, 'omitnan');
getmean_RWS_SST_Gq_pre_dcz = mean(RWS_SST_Gq_pre_dcz{choosecell}, 2, 'omitnan');
getmean_RWS_SST_Gq_post = mean(RWS_SST_Gq_post{choosecell}, 2, 'omitnan');

getmean_control_SST_Gq_pre = mean(control_SST_Gq_pre{choosecell}, 2, 'omitnan');
getmean_control_SST_Gq_pre_dcz = mean(control_SST_Gq_pre_dcz{choosecell}, 2, 'omitnan');
getmean_control_SST_Gq_post = mean(control_SST_Gq_post{choosecell}, 2, 'omitnan');

getmean_RWSCF_VIP_Gq_pre = mean(RWSCF_VIP_Gq_pre{choosecell}, 2, 'omitnan');
getmean_RWSCF_VIP_Gq_pre_dcz = mean(RWSCF_VIP_Gq_pre_dcz{choosecell}, 2, 'omitnan');
getmean_RWSCF_VIP_Gq_post = mean(RWSCF_VIP_Gq_post{choosecell}, 2, 'omitnan');

getmean_control_VIP_Gq_pre = mean(control_VIP_Gq_pre{choosecell}, 2, 'omitnan');
getmean_control_VIP_Gq_pre_dcz = mean(control_VIP_Gq_pre_dcz{choosecell}, 2, 'omitnan');
getmean_control_VIP_Gq_post = mean(control_VIP_Gq_post{choosecell}, 2, 'omitnan');

getmean_RWS_VIP_Gi_pre = mean(RWS_VIP_Gi_pre{choosecell}, 2, 'omitnan');
getmean_RWS_VIP_Gi_pre_dcz = mean(RWS_VIP_Gi_pre_dcz{choosecell}, 2, 'omitnan');
getmean_RWS_VIP_Gi_post = mean(RWS_VIP_Gi_post{choosecell}, 2, 'omitnan');

getmean_control_VIP_Gi_pre = mean(control_VIP_Gi_pre{choosecell}, 2, 'omitnan');
getmean_control_VIP_Gi_pre_dcz = mean(control_VIP_Gi_pre_dcz{choosecell}, 2, 'omitnan');
getmean_control_VIP_Gi_post = mean(control_VIP_Gi_post{choosecell}, 2, 'omitnan');

getmean_SST_Gi_ZI_pre = mean(SST_Gi_ZI_pre{choosecell}, 2, 'omitnan');
getmean_SST_Gi_ZI_pre_wo = mean(SST_Gi_ZI_pre_wo{choosecell}, 2, 'omitnan');
getmean_SST_Gi_ZI_pre_dcz = mean(SST_Gi_ZI_pre_dcz{choosecell}, 2, 'omitnan');
getmean_SST_Gi_ZI_pre_dcz_wo = mean(SST_Gi_ZI_pre_dcz_wo{choosecell}, 2, 'omitnan');
...
getsem_RWS_pre = mean(RWS_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWS_pre{choosecell}, 2));
getsem_RWS_post = mean(RWS_post{choosecell}, 2, 'omitnan') / sqrt(size(RWS_post{choosecell}, 2));

getsem_RWSCF_pre = mean(RWSCF_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_pre{choosecell}, 2));
getsem_RWSCF_post = mean(RWSCF_post{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_post{choosecell}, 2));

getsem_RWSCF_PV_JAWS_pre = mean(RWSCF_PV_JAWS_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_PV_JAWS_pre{choosecell}, 2));
getsem_RWSCF_PV_JAWS_post = mean(RWSCF_PV_JAWS_post{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_PV_JAWS_post{choosecell}, 2));

getsem_control_PV_JAWS_pre = mean(control_PV_JAWS_pre{choosecell}, 2, 'omitnan') / sqrt(size(control_PV_JAWS_pre{choosecell}, 2));
getsem_control_PV_JAWS_post = mean(control_PV_JAWS_post{choosecell}, 2, 'omitnan') / sqrt(size(control_PV_JAWS_post{choosecell}, 2));

getsem_RWSCF_PV_Gi_pre = mean(RWSCF_PV_Gi_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_PV_Gi_pre{choosecell}, 2));
getsem_RWSCF_PV_Gi_pre_dcz = mean(RWSCF_PV_Gi_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_PV_Gi_pre_dcz{choosecell}, 2));
getsem_RWSCF_PV_Gi_post = mean(RWSCF_PV_Gi_post{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_PV_Gi_post{choosecell}, 2));

getsem_control_PV_Gi_pre = mean(control_PV_Gi_pre{choosecell}, 2, 'omitnan') / sqrt(size(control_PV_Gi_pre{choosecell}, 2));
getsem_control_PV_Gi_pre_dcz = mean(control_PV_Gi_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(control_PV_Gi_pre_dcz{choosecell}, 2));
getsem_control_PV_Gi_post = mean(control_PV_Gi_post{choosecell}, 2, 'omitnan') / sqrt(size(control_PV_Gi_post{choosecell}, 2));

getsem_RWS_PV_Gq_pre = mean(RWS_PV_Gq_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWS_PV_Gq_pre{choosecell}, 2));
getsem_RWS_PV_Gq_pre_dcz = mean(RWS_PV_Gq_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(RWS_PV_Gq_pre_dcz{choosecell}, 2));
getsem_RWS_PV_Gq_post = mean(RWS_PV_Gq_post{choosecell}, 2, 'omitnan') / sqrt(size(RWS_PV_Gq_post{choosecell}, 2));

getsem_control_PV_Gq_pre = mean(control_PV_Gq_pre{choosecell}, 2, 'omitnan') / sqrt(size(control_PV_Gq_pre{choosecell}, 2));
getsem_control_PV_Gq_pre_dcz = mean(control_PV_Gq_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(control_PV_Gq_pre_dcz{choosecell}, 2));
getsem_control_PV_Gq_post = mean(control_PV_Gq_post{choosecell}, 2, 'omitnan') / sqrt(size(control_PV_Gq_post{choosecell}, 2));

getsem_RWSCF_SST_Gi_pre = mean(RWSCF_SST_Gi_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_SST_Gi_pre{choosecell}, 2));
getsem_RWSCF_SST_Gi_pre_dcz = mean(RWSCF_SST_Gi_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_SST_Gi_pre_dcz{choosecell}, 2));
getsem_RWSCF_SST_Gi_post = mean(RWSCF_SST_Gi_post{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_SST_Gi_post{choosecell}, 2));

getsem_control_SST_Gi_pre = mean(control_SST_Gi_pre{choosecell}, 2, 'omitnan') / sqrt(size(control_SST_Gi_pre{choosecell}, 2));
getsem_control_SST_Gi_pre_dcz = mean(control_SST_Gi_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(control_SST_Gi_pre_dcz{choosecell}, 2));
getsem_control_SST_Gi_post = mean(control_SST_Gi_post{choosecell}, 2, 'omitnan') / sqrt(size(control_SST_Gi_post{choosecell}, 2));

getsem_RWS_SST_Gq_pre = mean(RWS_SST_Gq_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWS_SST_Gq_pre{choosecell}, 2));
getsem_RWS_SST_Gq_pre_dcz = mean(RWS_SST_Gq_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(RWS_SST_Gq_pre_dcz{choosecell}, 2));
getsem_RWS_SST_Gq_post = mean(RWS_SST_Gq_post{choosecell}, 2, 'omitnan') / sqrt(size(RWS_SST_Gq_post{choosecell}, 2));

getsem_control_SST_Gq_pre = mean(control_SST_Gq_pre{choosecell}, 2, 'omitnan') / sqrt(size(control_SST_Gq_pre{choosecell}, 2));
getsem_control_SST_Gq_pre_dcz = mean(control_SST_Gq_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(control_SST_Gq_pre_dcz{choosecell}, 2));
getsem_control_SST_Gq_post = mean(control_SST_Gq_post{choosecell}, 2, 'omitnan') / sqrt(size(control_SST_Gq_post{choosecell}, 2));

getsem_RWSCF_VIP_Gq_pre = mean(RWSCF_VIP_Gq_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_VIP_Gq_pre{choosecell}, 2));
getsem_RWSCF_VIP_Gq_pre_dcz = mean(RWSCF_VIP_Gq_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_VIP_Gq_pre_dcz{choosecell}, 2));
getsem_RWSCF_VIP_Gq_post = mean(RWSCF_VIP_Gq_post{choosecell}, 2, 'omitnan') / sqrt(size(RWSCF_VIP_Gq_post{choosecell}, 2));

getsem_control_VIP_Gq_pre = mean(control_VIP_Gq_pre{choosecell}, 2, 'omitnan') / sqrt(size(control_VIP_Gq_pre{choosecell}, 2));
getsem_control_VIP_Gq_pre_dcz = mean(control_VIP_Gq_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(control_VIP_Gq_pre_dcz{choosecell}, 2));
getsem_control_VIP_Gq_post = mean(control_VIP_Gq_post{choosecell}, 2, 'omitnan') / sqrt(size(control_VIP_Gq_post{choosecell}, 2));

getsem_RWS_VIP_Gi_pre = mean(RWS_VIP_Gi_pre{choosecell}, 2, 'omitnan') / sqrt(size(RWS_VIP_Gi_pre{choosecell}, 2));
getsem_RWS_VIP_Gi_pre_dcz = mean(RWS_VIP_Gi_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(RWS_VIP_Gi_pre_dcz{choosecell}, 2));
getsem_RWS_VIP_Gi_post = mean(RWS_VIP_Gi_post{choosecell}, 2, 'omitnan') / sqrt(size(RWS_VIP_Gi_post{choosecell}, 2));

getsem_control_VIP_Gi_pre = mean(control_VIP_Gi_pre{choosecell}, 2, 'omitnan') / sqrt(size(control_VIP_Gi_pre{choosecell}, 2));
getsem_control_VIP_Gi_pre_dcz = mean(control_VIP_Gi_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(control_VIP_Gi_pre_dcz{choosecell}, 2));
getsem_control_VIP_Gi_post = mean(control_VIP_Gi_post{choosecell}, 2, 'omitnan') / sqrt(size(control_SST_Gi_post{choosecell}, 2));

getsem_SST_Gi_ZI_pre = mean(SST_Gi_ZI_pre{choosecell}, 2, 'omitnan') / sqrt(size(SST_Gi_ZI_pre{choosecell}, 2));
getsem_SST_Gi_ZI_pre_wo = mean(SST_Gi_ZI_pre_wo{choosecell}, 2, 'omitnan') / sqrt(size(SST_Gi_ZI_pre_wo{choosecell}, 2));
getsem_SST_Gi_ZI_pre_dcz = mean(SST_Gi_ZI_pre_dcz{choosecell}, 2, 'omitnan') / sqrt(size(SST_Gi_ZI_pre_dcz{choosecell}, 2));
getsem_SST_Gi_ZI_pre_dcz_wo = mean(SST_Gi_ZI_pre_dcz_wo{choosecell}, 2, 'omitnan') / sqrt(size(SST_Gi_ZI_pre_dcz_wo{choosecell}, 2));
...
plot(getmean_RWS_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWS_post), length(getmean_RWS_post):-1:1], [getmean_RWS_post - getsem_RWS_post; flipud(getmean_RWS_post + getsem_RWS_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
title('RWS')
ylabel('∆F/F0')
...
plot(getmean_RWSCF_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWSCF_post), length(getmean_RWSCF_post):-1:1], [getmean_RWSCF_post - getsem_RWSCF_post; flipud(getmean_RWSCF_post + getsem_RWSCF_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
title('RWSCF')
ylabel('∆F/F0')
...
plot(getmean_RWSCF_PV_JAWS_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWSCF_PV_JAWS_post), length(getmean_RWSCF_PV_JAWS_post):-1:1], [getmean_RWSCF_PV_JAWS_post - getsem_RWSCF_PV_JAWS_post; flipud(getmean_RWSCF_PV_JAWS_post + getsem_RWSCF_PV_JAWS_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
title('RWSCF PV JAWS')
ylabel('∆F/F0')
...
plot(getmean_control_PV_JAWS_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_control_PV_JAWS_post), length(getmean_control_PV_JAWS_post):-1:1], [getmean_control_PV_JAWS_post - getsem_control_PV_JAWS_post; flipud(getmean_control_PV_JAWS_post + getsem_control_PV_JAWS_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
title('PV JAWS')
ylabel('∆F/F0')
...
plot(getmean_RWSCF_PV_Gi_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWSCF_PV_Gi_post), length(getmean_RWSCF_PV_Gi_post):-1:1], [getmean_RWSCF_PV_Gi_post - getsem_RWSCF_PV_Gi_post; flipud(getmean_RWSCF_PV_Gi_post + getsem_RWSCF_PV_Gi_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_control_PV_Gi_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_control_PV_Gi_post), length(getmean_control_PV_Gi_post):-1:1], [getmean_control_PV_Gi_post - getsem_control_PV_Gi_post; flipud(getmean_control_PV_Gi_post + getsem_control_PV_Gi_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
title('PV Inhibition')
ylabel('∆F/F0')
...
plot(getmean_RWS_PV_Gq_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWS_PV_Gq_post), length(getmean_RWS_PV_Gq_post):-1:1], [getmean_RWS_PV_Gq_post - getsem_RWS_PV_Gq_post; flipud(getmean_RWS_PV_Gq_post + getsem_RWS_PV_Gq_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_control_PV_Gq_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_control_PV_Gq_post), length(getmean_control_PV_Gq_post):-1:1], [getmean_control_PV_Gq_post - getsem_control_PV_Gq_post; flipud(getmean_control_PV_Gq_post + getsem_control_PV_Gq_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
title('PV Activation')
ylabel('∆F/F0')
...
plot(getmean_RWSCF_SST_Gi_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWSCF_SST_Gi_post), length(getmean_RWSCF_SST_Gi_post):-1:1], [getmean_RWSCF_SST_Gi_post - getsem_RWSCF_SST_Gi_post; flipud(getmean_RWSCF_SST_Gi_post + getsem_RWSCF_SST_Gi_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_control_SST_Gi_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_control_SST_Gi_post), length(getmean_control_SST_Gi_post):-1:1], [getmean_control_SST_Gi_post - getsem_control_SST_Gi_post; flipud(getmean_control_SST_Gi_post + getsem_control_SST_Gi_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_RWS_SST_Gq_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWS_SST_Gq_post), length(getmean_RWS_SST_Gq_post):-1:1], [getmean_RWS_SST_Gq_post - getsem_RWS_SST_Gq_post; flipud(getmean_RWS_SST_Gq_post + getsem_RWSCF_SST_Gi_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_control_SST_Gq_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_control_SST_Gq_post), length(getmean_control_SST_Gq_post):-1:1], [getmean_control_SST_Gq_post - getsem_control_SST_Gq_post; flipud(getmean_control_SST_Gq_post + getsem_control_SST_Gq_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_RWSCF_VIP_Gq_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWSCF_VIP_Gq_post), length(getmean_RWSCF_VIP_Gq_post):-1:1], [getmean_RWSCF_VIP_Gq_post - getsem_RWSCF_VIP_Gq_post; flipud(getmean_RWSCF_VIP_Gq_post + getsem_RWSCF_VIP_Gq_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_control_VIP_Gq_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_control_VIP_Gq_post), length(getmean_control_VIP_Gq_post):-1:1], [getmean_control_VIP_Gq_post - getsem_control_VIP_Gq_post; flipud(getmean_control_VIP_Gq_post + getsem_control_VIP_Gq_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_RWS_VIP_Gi_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_RWS_VIP_Gi_post), length(getmean_RWS_VIP_Gi_post):-1:1], [getmean_RWS_VIP_Gi_post - getsem_RWS_VIP_Gi_post; flipud(getmean_RWS_VIP_Gi_post + getsem_RWS_VIP_Gi_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
...
plot(getmean_control_VIP_Gi_post, 'Color', neuron_colors{choosecell}, 'LineWidth', 2)
fill([1:length(getmean_control_VIP_Gi_post), length(getmean_control_VIP_Gi_post):-1:1], [getmean_control_VIP_Gi_post - getsem_control_VIP_Gi_post; flipud(getmean_control_VIP_Gi_post + getsem_control_VIP_Gi_post)], neuron_colors{choosecell}, 'linestyle', 'none', 'FaceAlpha', 0.5);
xlim(xlimits)
ylim(ylimits)
