function [pre, pre_o, pre_DCZ, pre_DCZ_o] = parsemouse_W_O_ZI(motiontype, celltype, allData, mouse, choosesignal, baselineshift, baselineshiftperiod, baseline_reject_thresh, trialavg)
...
if strcmp(motiontype, 'all')
    ...
    wo_DCZ_trials = strcmp(tetPeriod, 'PRE') & strcmp(trialType, 'O') & strcmp(dczPeriod, 'DCZ');
    ...
    wo_DCZ_trials = strcmp(tetPeriod, 'PRE') & strcmp(trialType, 'O') & strcmp(dczPeriod, 'DCZ') & strcmp(motionType, motiontype);
...
pre_DCZ_o = signal(:, cells, wo_DCZ_trials);
