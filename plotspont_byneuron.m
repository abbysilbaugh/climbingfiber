function plotspont_byneuron(m1_cond1, m1_cond2, m2_cond1, m2_cond2, neuron_colors, plotlines, group_names, condition_names, ylimits)

m1_cond1 = mouseconcatenate(m1_cond1);
m1_cond2 = mouseconcatenate(m1_cond2);
m2_cond1 = mouseconcatenate(m2_cond1);
m2_cond2 = mouseconcatenate(m2_cond2);
...
dabarplot(m1_PN,'xtlabels', condition_names,'fill', 0,  ...
    'scatter',2,'scattersize',2,'scatteralpha',1, 'outliers',0, 'color', [0.5 0.5 0.5], 'mean', '1');
ylim(ylimits)
if p_m1_PN < 0.05
...
dabarplot(m2_PN,'xtlabels', condition_names,'fill', 0, ...
    'scatter',2,'scattersize',2,'scatteralpha',1, 'outliers',0, 'color', neuron_colors{2});
ylim(ylimits)
if p_m2_PN < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 2)
if ~isempty(m2_UC)
dabarplot(m2_UC,'xtlabels', condition_names,'fill', 0, ...
    'scatter',2,'scattersize',2,'scatteralpha',1, 'outliers',0, 'color', neuron_colors{4});
ylim(ylimits)
if p_m2_UC < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 3)
if ~isempty(m2_VIP)
dabarplot(m2_VIP,'xtlabels', condition_names,'fill', 0, ...
    'scatter',2,'scattersize',2,'scatteralpha',1, 'outliers',0, 'color', neuron_colors{3});
ylim(ylimits)
if p_m2_VIP < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 4)
if ~isempty(m2_SST)
dabarplot(m2_SST,'xtlabels', condition_names,'fill', 0, ...
    'scatter',2,'scattersize',2,'scatteralpha',1, 'outliers',0, 'color', neuron_colors{5});
ylim(ylimits)
if p_m2_SST < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 5)
if ~isempty(m2_PV)
dabarplot(m2_PV,'xtlabels', condition_names,'fill', 0, ...
    'scatter',2,'scattersize',2,'scatteralpha',1, 'outliers',0, 'color', neuron_colors{1});
ylim(ylimits)
if p_m2_PV < 0.05
    text(1.5, 1, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
