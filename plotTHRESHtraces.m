function plotTHRESHtraces_trialpool(allData, cellType, cellmotType, trialmotType, variable, exclude, ylimit, xlimit, norm, gettitle, savename)

[PSI_4, PSI_4_vartype] = grabTHRESHdata(allData, cellType, cellmotType, 'W', trialmotType, 'all', variable, exclude, 'PSI_4');
[PSI_4, PSI_4_vartype] = trialpool(PSI_4, PSI_4_vartype);
[PSI_4_cat, varcattype] = catmice(allData, PSI_4, PSI_4_vartype, 'all');

[PSI_6, PSI_6_vartype] = grabTHRESHdata(allData, cellType, cellmotType, 'W', trialmotType, 'all', variable, exclude, 'PSI_6');
[PSI_6, PSI_6_vartype] = trialpool(PSI_6, PSI_6_vartype);
[PSI_6_cat, varcattype] = catmice(allData, PSI_6, PSI_6_vartype, 'all');

[PSI_8, PSI_8_vartype] = grabTHRESHdata(allData, cellType, cellmotType, 'W', trialmotType, 'all', variable, exclude, 'PSI_8');
[PSI_8, PSI_8_vartype] = trialpool(PSI_8, PSI_8_vartype);
[PSI_8_cat, varcattype] = catmice(allData, PSI_8, PSI_8_vartype, 'all');

[PSI_10, PSI_10_vartype] = grabTHRESHdata(allData, cellType, cellmotType, 'W', trialmotType, 'all', variable, exclude, 'PSI_10');
[PSI_10, PSI_10_vartype] = trialpool(PSI_10, PSI_10_vartype);
[PSI_10_cat, varcattype] = catmice(allData, PSI_10, PSI_10_vartype, 'all');

[PSI_12, PSI_12_vartype] = grabTHRESHdata(allData, cellType, cellmotType, 'W', trialmotType, 'all', variable, exclude, 'PSI_12');
[PSI_12, PSI_12_vartype] = trialpool(PSI_12, PSI_12_vartype);
[PSI_12_cat, varcattype] = catmice(allData, PSI_12, PSI_12_vartype, 'all');
