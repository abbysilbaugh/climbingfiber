...
subplot(1, 5, 1)
if ~isempty(m1_PN)
dabarplot(m1_PN,'xtlabels', condition_names,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'outliers',0, 'color', neuron_colors{2});
ylim(ylimits)
if p_m1_PN < 0.05
    text(1.5, 0.05, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
title(group_names(1))
end
...
subplot(1, 5, 2)
if ~isempty(m1_UC)
dabarplot(m1_UC,'xtlabels', condition_names, 'scatter',0,'scattersize',25,'scatteralpha',0.6,'outliers',0, 'color', neuron_colors{4});
ylim(ylimits)
if p_m1_UC < 0.05
    text(1.5, 0.05, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
end
...
subplot(1, 5, 3)
if ~isempty(m1_VIP)
dabarplot(m1_VIP,'xtlabels', condition_names,...
...
subplot(1, 5, 4)
if ~isempty(m1_SST)
dabarplot(m1_SST,'xtlabels', condition_names,...
...
subplot(1, 5, 5)
if ~isempty(m1_PV)
dabarplot(m1_PV,'xtlabels', condition_names,...
...
subplot(1, 5, 1)
if ~isempty(m2_PN)
dabarplot(m2_PN,'xtlabels', condition_names,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'outliers',0, 'color', neuron_colors{2});
ylim(ylimits)
if p_m2_PN < 0.05
    text(1.5, 0.05, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
...
subplot(1, 5, 2)
if ~isempty(m2_UC)
dabarplot(m2_UC,'xtlabels', condition_names,...
...
subplot(1, 5, 3)
if ~isempty(m2_VIP)
dabarplot(m2_VIP,'xtlabels', condition_names,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'outliers',0, 'color', neuron_colors{3});
ylim(ylimits)
if p_m2_VIP < 0.05
    text(1.5, 0.05, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
...
subplot(1, 5, 4)
if ~isempty(m2_SST)
dabarplot(m2_SST,'xtlabels', condition_names,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'outliers',0, 'color', neuron_colors{5});
ylim(ylimits)
if p_m2_SST < 0.05
    text(1.5, 0.05, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
...
subplot(1, 5, 5)
if ~isempty(m2_PV)
dabarplot(m2_PV,'xtlabels', condition_names,...
    'scatter',0,'scattersize',25,'scatteralpha',0.6,'outliers',0, 'color', neuron_colors{1});
ylim(ylimits)
if p_m2_PV < 0.05
    text(1.5, 0.05, '*', 'HorizontalAlignment', 'center', 'FontSize', 50);
...
dabarplot(PNs,...
    ...
    'outliers',0,'scatter',0, 'color', [neuron_colors{2}; neuron_colors{2}]);
ylabel('Maximum (ΔF/F0)'); 
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
...
dabarplot(UCs,...
    'xtlabels', condition_names,...
    'outliers',0,'scatter',0, 'color', [neuron_colors{4}; neuron_colors{4}]);
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
...
dabarplot(VIPs,...
    'xtlabels', condition_names,...
    'outliers',0,'scatter',0, 'color', [neuron_colors{3}; neuron_colors{3}]); 
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
...
dabarplot(PVs,...
    'xtlabels', condition_names,...
    'outliers',0,'scatter',0, 'color', [neuron_colors{1}; neuron_colors{1}]);
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
...
dabarplot(SSTs,...
    'xtlabels', condition_names,...
    'outliers',0,'scatter',0, 'color', [neuron_colors{5}; neuron_colors{5}]);
ylim(ylimits)
set(gca, 'FontSize', 7 ,'FontName', 'Helvetica')
end
