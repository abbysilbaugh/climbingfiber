function [allData] = getmeanbefore(allData, frame_win)
...
for i = 1:nMice
    ...
    allData.data{i}.mean_fluo_in_win_before = mean_fluo_in_win; % average fluorescence in window
    allData.data{i}.mean_num_mot_before = mean_num_mot; % number of mot frames in window
